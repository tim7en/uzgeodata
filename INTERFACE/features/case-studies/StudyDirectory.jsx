...
export default function StudyDirectory() {
  ...
  return <div className="cs-app cs-directory">
    ...
    <header className="cs-header"><a className="cs-logo" href="/"><Droplets size={22}/> UZGEODATA</a><nav><a href="/">Explore the basin map <ArrowUpRight size={14}/></a><ThemeToggle/><LanguageSelect/></nav></header>
    <main>
