...
function AdminPanel() {
  ...
  return <div className="admin-app">
    ...
    <main className="admin-main"><a href="/admin.html">Open variable freshness & update controls →</a><div className="admin-title"><div><div className="kicker">Data operations</div><h1>Repository<br/><span>control.</span></h1></div><p>Upload, document and manage the files that power the UzGeoData catalog.</p></div>
