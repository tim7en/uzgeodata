...
export default function ChirchikStudy() {
  ...
  return <div className="cs-app">
    <header className="cs-header"><a className="cs-logo" href="/"><Droplets size={22} /> UZGEODATA <span>/ FIELD STUDIES</span></a><nav><a href="/climate.html">Climate</a><a href="/hydrography.html">Hydrography</a><a href={`${BASE}chirchik-deep-study.md`} download><Download size={14} /> Study report</a><ThemeToggle/><LanguageSelect/></nav></header>
    <main>
