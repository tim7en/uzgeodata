...
function App() {
  ...
  return <main>
    ...
    {data && <>
      ...
      <PskemAtlasBatch/>
      <p><a href="/data-lineage.html">Data lineage: source availability, saved coverage and update classes →</a> · <a href="/dynamic-atlas.html">Dynamic HydroATLAS methods →</a></p>
      ...
      <section className="contract"><h2>Reproduction is a release requirement.</h2><p>Every result needs pinned inputs, a versioned method, execution records, declared tolerances, comparison against the reference and an independent rerun.</p><div className="downloads"><a href="/data/atlas/reproducibility.md" download>Scientific requirements ↓</a><a href="/data/atlas/methodology.md" download>Methodology ↓</a><a href="/data/atlas/recipes.md" download>All attribute pseudocode ↓</a><a href="/surrogates.html">Open-data surrogates: the scientific record ↗</a><a href="/data/atlas/surrogates.md" download>Open-data surrogate plan ↓</a><a href="/data/atlas/roadmap.json" download>Machine-readable specification ↓</a></div></section>
