...
def report(d,a,paths):
    ...
    lines+=['','## Further professional analyses, in order of value','',
        ...
        'The Sabitov extension now supplies daily ERA5 precipitation, temperature and radiation, four daily snow/soil/groundwater model adaptations and independent temporal satellite process checks. See sabitov-2018-review.md, sabitov-methods.json and sabitov-methods-atlas.pdf for results and limitations. Daily station forcing is still needed to verify local weather errors. Full energy-balance melt additionally requires explicit humidity, wind, albedo and cloud treatment.','',
